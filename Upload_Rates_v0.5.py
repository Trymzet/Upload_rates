...
RU_rates_string = load_xml("http://www.cbr.ru/scripts/XML_daily_eng.asp?", "RU")
RU_etree = ElementTree.fromstring(RU_rates_string)
...
RU_data.iloc[:, 2] = array(RU_excel_date_format)
